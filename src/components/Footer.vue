<template>
   <div class="foot-btn" >
      <ul>
        <router-link tag='li' class="home" active-class='home_active' to='/home'>
          <a href="javascript:;"></a>
        </router-link>
        <router-link tag='li' class="write" active-class='write_active' to='/shopcar'>
          <a href="javascript:;"></a>
        </router-link>
        <router-link tag='li' class="my" active-class='my_active' to='/user'>
          <a href="javascript:;"></a>
        </router-link>
